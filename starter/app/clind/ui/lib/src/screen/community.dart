    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        ...
        body: PageView.builder(
          ...
          onPageChanged: (index) => _updateTabIndex(index % CommunityTabType.values.length),
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: ListView.separated(
                                ...
                                itemCount: 10,
                                itemBuilder: (context, index) => ClindChannelChip(
                                  imageUrl:
                                      'https://storage.googleapis.com/static.fastcampus.co.kr/prod/uploads/202402/171543-924/thumb.jpg',
                                  name: '새해',
                                  onTap: () {},
                                ),
